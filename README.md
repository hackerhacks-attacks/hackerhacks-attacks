...
| Area | Review Value |
|---|---|
| **Secure Systems** | Architecture review, trust boundaries, hardening logic, and systems-level security thinking. |
| **Security Research** | Controlled analysis, methodology, vulnerability-class study, and defensive implications. |
| **Detection Engineering** | Telemetry interpretation, behavior mapping, detection logic, and incident evidence. |
| **Technical Documentation** | Clear writing, reproducible notes, and professional explanation of security work. |
